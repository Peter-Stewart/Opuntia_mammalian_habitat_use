...
mod_f_l <- cstan(file = "C:/temp/models/distance.stan",
                 data = dlist_f_l,
                 chains = 4, 
                 cores = 4,
                 warmup = 1500, 
...
mod_n_l <- cstan(file = "C:/temp/models/distance.stan",
                 data = dlist_n_l,
                 chains = 4, 
                 cores = 4,
                 warmup = 1500, 
...
mod_f_m <- cstan(file = "C:/C:/temp/models/distance.stan",
                 data = dlist_f_m,
                 chains = 4, 
                 cores = 4,
                 warmup = 1500, 
...
mod_n_m <- cstan(file = "C:/temp/models/distance.stan",
                 data = dlist_n_m,
                 chains = 4, 
                 cores = 4,
                 warmup = 1500, 
...
mod_f_s <- cstan(file = "C:/temp/models/distance.stan",
                 data = dlist_f_s,
                 chains = 4, 
                 cores = 4,
                 warmup = 1500, 
...
mod_n_s <- cstan(file = "C:/temp/models/distance.stan",
                 data = dlist_n_s,
                 chains = 4, 
                 cores = 4,
                 warmup = 1500, 
